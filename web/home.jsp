...
<html lang="en">
    ...
    <head>
        ...
        <title>Nutritious Food Store</title>
        ...
        <script>
            $(document).ready(function(){
                $(".owl-carousel").owlCarousel({
                    items: 1,           // Hiển thị 1 slide mỗi lần
                    loop: true,        // Lặp lại vô tận
                    autoplay: true,    // Tự động chạy
                    autoplayTimeout: 5000, // 5 giây đổi hình
                    nav: true,         // Hiện nút Next/Prev
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section_title">
                            <h2 class=text-shadow" style="font-size: 20px;"><span class="ani-fire">New Products 2026</span></h2>
                        ...
                        <figure class="single_banner">
                            <div class="banner_thumb">
                                ...
                                <div class="banner_content">
                                    <h3>Sale up to</h3>
                                    <h2>50%</h2>
                                    <p>Product <span> & </span> Body Spray</p>
                                </div>
                            </div>
                        </figure>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-7">
                            <div class="widgets_container contact_us">
                                ...
                                <div class="footer_desc">
                                    <p>Receive all types of functional foods from us with the fastest delivery time within 2 days. We can even accept intermediary orders for products that are currently not available on the platform. To do this, please send an email to the company's email address.</p>
                                </div>
                                <p>
                                    <span>Address :</span> Khu đô thị FPT City, Ngũ Hành Sơn, Đà Nẵng 550000, Việt Nam
                                </p>
                                <p><span>Email :</span> <a href="#">contact@nutrisense.com</a></p>
                                <p><span>Phone :</span> <a href="tel: +91 8888884444">1900 9090</a> </p>
                                <p style="margin-top: 20px">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3835.8561681224114!2d108.25831101167952!3d15.968885884632305!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3142116949840599%3A0x365b35580f52e8d5!2zxJDhuqFpIGjhu41jIEZQVCDEkMOgIE7hurVuZw!5e0!3m2!1svi!2s!4v1772553776742!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </p>
                            </div>
                        </div>
